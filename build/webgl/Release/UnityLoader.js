...
function LoadJSCode(e, t)
{
	if (!Math.fround)
	{
		...
		{
			if (47 == e[r] && 47 == e[r + 1] && 32 == e[r + 2] && String.fromCharCode.apply(null, e.subarray(r + 3, r + 3 + o[s].length)) === o[s])
			{
				s++;
			}
		  ...
		  return i
			...
			2                                                                                         : [function (e, t, n)
			{
				...
				d[254] = d[254] = 1, n.string2buf = function (e)
				{
					...
					for (a = 0; s > a; a++)
					{
						n = e.charCodeAt(a), 55296 === (64512 & n) && s > a + 1 && (o = e.charCodeAt(a + 1), 56320 === (64512 & o) && (n = 65536 + (n - 55296 << 10) + (o - 56320), a++)), d += 128 > n ? 1 : 2048 > n ? 2 : 65536 > n ? 3 : 4;
					}
			...
			7                                                                                         : [function (e, t, n)
			{
				...
				t.exports = function (e, t)
				{
					...
					e:do {
						...
						t:for (; ;)
						{
							if (_ = y >>> 24, m >>>= _, w -= _, _ = y >>> 16 & 255, 0 === _)
							{
								D[s++] = 65535 & y;
							}
							else
			...
			8                                                                                         : [function (e, t, n)
			{
				...
				function u(e)
				{
					...
					{
						var t;
						for (m = new b.Buf32(512), w = new b.Buf32(32), t = 0; 144 > t;)
						{
							e.lens[t++] = 8;
						}
						for (; 256 > t;)
						...
						for (y(S, e.lens, 0, 288, m, 0, e.work, {bits: 9}), t = 0; 32 > t;)
						{
							e.lens[t++] = 5;
						}
					...
					e:for (; ;)
					{
						switch (n.mode)
						{
							...
							case P:
								...
								n.mode = Z;
							case Z:
								if (1024 & n.flags && (w = n.length, w > d && (w = d), w && (n.head && (_e = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), b.arraySet(n.head.extra, i, r, w, _e)), 512 & n.flags && (n.check = v(n.check, i, w, r)), d -= w, r += w, n.length -= w), n.length))
								{
									break e;
								}
								n.length = 0, n.mode = q;
							case q:
								if (2048 & n.flags)
								{
									...
									w = 0;
									do {
										_e = i[r + w++], n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e));
									} while (_e && d > w);
									if (512 & n.flags && (n.check = v(n.check, i, w, r)), d -= w, r += w, _e)
									{
										break e
									}
								}
							...
							case G:
								if (4096 & n.flags)
								{
									...
									w = 0;
									do {
										_e = i[r + w++], n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e));
									} while (_e && d > w);
									if (512 & n.flags && (n.check = v(n.check, i, w, r)), d -= w, r += w, _e)
									{
										break e
							...
							case J:
								if (0 === n.havedict)
								{
									return e.next_out = s, e.avail_out = l, e.next_in = r, e.avail_in = d, n.hold = f, n.bits = h, I;
								}
...
"undefined" == typeof Module && (Module = eval("(function() { try { return Module || {} } catch(e) { return {} } })()")), Module.expectedDataFileDownloads || (Module.expectedDataFileDownloads = 0, Module.finishedDataFileDownloads = 0), Module.expectedDataFileDownloads++, function ()
{
	var e = function (e)
	{
		...
		function n()
		{
			...
			}, new t(0, 13922163, 0, 0).open("GET", "/data.unity3d"), new t(13922163, 13922184, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(13922184, 13925639, 0, 0).open("GET", "/preserved_derived_types.xml"), new t(13925639, 16009691, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(16009691, 16884663, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(16884663, 16912288, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_webgl.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {fromCache: !1}, d ? (n(d), d = null) : l = n
		}
		...
		var r = "function" == typeof Module.locateFile ? Module.locateFile(a) : (Module.filePackagePrefixURL || "") + a, s = 16912288, d = null, l = null;
